// ─── BUILDING INFO (logo name, subtitle, footers, property panel text) ────────
const DEFAULT_INFO = {
...
const INFO_FIELDS = [
  ...
  ['dirFoot',    'Directory Footer',           'Leasing line below the directory'],
  ['evtFoot',    'Events Footer',              'Contact line below the events'],
  ['photoTitle', 'Property Panel · Title',     'Main title on the Property photo panel'],
  ['photoSub',   'Property Panel · Subtitle',  'Subtitle under the property title'],
];
...
function resetInfoToDefault() {
  if (!confirm('Reset all building info to defaults?')) return;
